...
async def lifespan(app: FastAPI):
    ...
    # Said on its own line for the same reason as the TLS one: from behind a
    # VPN, whether downloads are signed in is the difference between a library
    # and a page of bot checks, and a cookie file that never mounted looks
    # exactly like never having set one.
    log.info("cookies: %s", download.cookies_status())
